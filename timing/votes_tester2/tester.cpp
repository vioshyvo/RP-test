...
int main(int argc, char **argv) {
    ...
    for (int j = 0; j < ks.size(); ++j) {
      ...
      for(const auto &v : votes) {
        ...
        outf << mean(projection_times) << " ";
        outf << mean(voting_times) << " ";
        outf << mean(exact_times) << " ";
        outf << build_time << " ";
        outf << mean(cs_sizes) << " ";
        outf << std::endl;
      }
      ...
      for (int arg = last_arg + 1; arg < argc; ++arg) {
        ...
        outf2 << mean(projection_times2) << " ";
        outf2 << mean(voting_times2) << " ";
        outf2 << mean(exact_times2) << " ";
        outf2 << build_time << " ";
        outf2 << mean(cs_sizes2) << " ";
        outf2 << mean(sorting_times2) << " ";
        outf2 << mean(choosing_times2) << " ";
        outf2 << std::endl;
      }
    }
